...
import { OrganiserLocations } from "@/components/organiser-locations";

export default async function OrganiserLocationsPage({
  searchParams,
}: {
  ...
  return (
    <main className="mx-auto max-w-2xl p-6">
      ...
      <p className="mt-1 text-sm text-gray-600">
        Add and manage venues for your club. You need at least one location before creating a class.
      </p>
      <div className="mt-6">
        <OrganiserLocations organisationId={orgId} />
      </div>
